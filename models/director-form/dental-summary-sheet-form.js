...
const dentalSummarySheetSchema = new mongoose.Schema({
  director:{
...
dentalSummarySheetSchema.pre(/^find/, function(next){
  this.populate([
...
module.exports = mongoose.model('dentalSummarySheet', dentalSummarySheetSchema);